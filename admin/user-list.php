...
<div class="p-4 sm:ml-64">
    <div class="bg-white shadow rounded p-4 space-y-4">
        ...
        <div class="flex items-center justify-between gap-4">
            ...
            <div class="space-x-2">
                <a href="user-new.php" class="no-print text-sm px-4 py-2 border rounded bg-blue-700 text-white">Create</a>
...
<script>
    $(document).ready(function() {
        ...
        $('#userTable tbody').on('click', '.edit-btn', function() {
            ...
            window.location.href="user-edit.php?id="+data.id;
        });
        ...
        $('#userTable tbody').on('click', '.delete-btn', function() {
            ...
            Swal.fire({
                title: 'Are you sure?',
                text: 'You are about to delete user with ID: ' + data.id,
                icon: 'warning',
