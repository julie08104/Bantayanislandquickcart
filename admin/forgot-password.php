<?php
    ...
    $cooldown = checkCooldown('admin_forgot_pw');
    ...
    if ($cooldown['cooldown']) {
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if ($user) {
                ...
                $stmt = $pdo->prepare("UPDATE users SET forgot_password_code = ? WHERE email = ?");
                ...
                resetFailedAttempts('admin_forgot_pw');
            } else {
                incrementFailedAttempts('admin_forgot_pw');
