<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $stmt = $pdo->prepare('INSERT INTO orders (address, latitude, longitude, store_id, customer_id, instruction, delivery_fee, status, created_at) VALUES (?, ?, ?, ?, ?, ?, ?, "pending", NOW())');
        if($stmt->execute([$address, $latitude, $longitude, $store_id, $id, $instruction, $delivery_fee])){
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <form method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" id="delivery_fee" name="delivery_fee" readonly class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" />
                </div>
